...
import 'package:shopping_app/features/profile/widgets/logout_dialog.dart';
        ...
        child: Column(
          children: [
            ...
            CustomCardProfile(
              ...
              child: Image.asset('assets/images/invinte friend.png'),
            ),
            const SizedBox(
              height: 15,
            ),
            ...
            GestureDetector(
                ...
                child: CustomCardProfile(
                    title: 'Logout',
                    child: Image.asset('assets/images/logoutt.png'))),
            const SizedBox(
              height: 40,
            ),
          ],
